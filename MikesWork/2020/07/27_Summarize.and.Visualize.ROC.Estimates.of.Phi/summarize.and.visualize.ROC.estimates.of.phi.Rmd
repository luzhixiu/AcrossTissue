---
title: "Summarize and Visualize ROC's Estimates of Phi"
...
- Replacement of ` ../25_Visualize.ROC.Estimates.of.Phi/visualize.ROC.estimates.of.phi.Rmd`.
- No longer label raw ROC output with gene names, instead that is processed in a separate .Rmd file and loaded here.
- Create and export summary statistics for genes across each one's various isoforms.
- This output should be useful for fitting models where ROC output is the predictor variables and E-MTAB data are the explanatory variables.
...
isoformSummaryStatsFile <- "Output/ROC.isoform.summary.stats-WB.fasta.sphi.equal.2.8.Rdata"
...
comment(isoformSummaryStats) <- paste0("Various summary stats of ROC phi output across a WormBase gene's isoforms. Columns include", names(isoformSummaryStats) )


save(isoformSummaryStats, file = isoformSummaryStatsFile)

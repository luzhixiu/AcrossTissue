...
unfilteredPhiPosteriorInfo <- readr::read_csv("Input/phi.posterior.unlabeled-NCBI.csv") %>% dplyr::rename(phi = PHI, logPhi = log10.PHI, sd = Std.Error, logSd = log10.Std.Error)
...
separateEmbryoStageCount <- read.csv(file="Output/summary.stats.of.embryo.stage.data.csv")

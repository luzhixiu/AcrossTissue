...
parser$add_argument("-d","--div",type="integer",default=4)
...
# parameter$initMutationCategories(c(mut),1)
...
expressionValues<- read_csv(file=paste(dir_name,"Parameter_est/gene_expression.txt",sep="/")

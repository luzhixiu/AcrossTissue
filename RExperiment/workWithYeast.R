...
load("/home/lu/AcrossTissue/RExperiment/E-MTAB-7657-yeast.Rdata")
...
write.table(countMatrix, "/home/lu/AcrossTissue/RExperiment/yeast_count.csv", sep=",",col.names=NA)

#This shows the col information
timeCollect=colData(rse)["time"]
...
#create the metadata
write.table(colData(rse), "/home/lu/AcrossTissue/RExperiment/yeast_metadata.SRR.csv", sep=",",col.names=NA)
...
srseDegObj=DESeqDataSet(rse,design = ~time)
